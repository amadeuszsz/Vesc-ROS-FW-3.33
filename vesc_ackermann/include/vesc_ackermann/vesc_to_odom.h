...
private:
  ...
  // odometry state
  double x_, y_, yaw_;
  vesc_msgs::VescServoStateStamped::ConstPtr last_servo_cmd_; ///< Last servo position commanded value
  ...
  void servoCmdCallback(const vesc_msgs::VescServoStateStamped::ConstPtr& servo);
};
